...
<body id="page-top">
  ...
  <script src="js/mirakl.js"></script>
          ...
          if (filter_input(INPUT_GET, "pl", FILTER_SANITIZE_FULL_SPECIAL_CHARS)) : ?>
            ...
            <script>
              ...
              $(document).ready(function() {
                modalConfirmaEliminar = new bootstrap.Modal(document.getElementById('modal-resultado-eliminar')); //Modal para mostrar el resultado
                /// VENTANAS MODALES
            ...
            <div class="modal-dialog modal-xl">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  ...
                  <!-- Ponemos una barra de navegación para movernos entre las secciones -->
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
          <a class="nav-link" href="#col-margen">Margen</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="#col-posicion">Posiciones</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="#col-acciones">Acciones</a>
        </li>
      </ul>
    </div>
  </div>
...
<!-- fin de la barra de navegación -->
                  ...
                  <h3 class="row bg-info text-white shadow p-3 m-1" id="col-acciones">
                    <div class="col-11">
                      Acciones
                    </div>
                  </h3>
