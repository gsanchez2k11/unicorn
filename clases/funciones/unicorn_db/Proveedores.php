...
require_once RAIZ . '/clases/objetos/Proveedores/Proveedor.php';
use clases\objetos\Proveedores\Proveedor as proveedor;
/**
 *
 */
class Proveedores extends General
{

  public static function obtieneProveedoresBd($datoproveedor = false)
     {
